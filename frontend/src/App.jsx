...
function App() {
 ...
 return (
    ...
    <div className="absolute top-0 -left-4 size-96 bg-pink-500 opacity-20 blur-[50px]" />
    <div className="absolute bottom-0 -right-4 size-96 bg-cyan-800 opacity-20 blur-[50px]" />
